          ...
          <div className="mb-1 md:mb-4 flex flex-col md:flex-row md:items-start justify-between gap-1 md:gap-4 shrink-0">
            ...
            <div className="flex bg-slate-100 p-1 rounded-lg w-full sm:w-max shadow-inner mt-1 md:mt-0 shrink-0">
              <button 
                ...
                className={`flex-1 sm:flex-none justify-center px-2 py-1 md:px-4 md:py-2 rounded-md text-xs md:text-sm font-bold transition-all duration-200 flex items-center gap-1 md:gap-2 ${viewMode === 'burnup' ? 'bg-emerald-600/75 shadow-sm text-white' : 'text-emerald-600 hover:text-emerald-800'}`}
              >
              ...
              <button 
                ...
                className={`flex-1 sm:flex-none justify-center px-2 py-1 md:px-4 md:py-2 rounded-md text-xs md:text-sm font-bold transition-all duration-200 flex items-center gap-1 md:gap-2 ${viewMode === 'burndown' ? 'bg-amber-600/75 shadow-sm text-white' : 'text-amber-600 hover:text-amber-800'}`}
              >
